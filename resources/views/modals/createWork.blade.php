<div id="modalWork" class="modal z-50 hidden w-full h-full bg-black/80 fixed left-0 top-0 flex justify-center items-start">
    <form method="POST" action="{{ secure_url(route('createWork')) }}" class="rounded-lg border-black border-[1px] relative flex flex-col items-center gap-5 bg-white p-10 w-1/3 mt-10
