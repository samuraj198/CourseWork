...
<div class="register-form flex flex-col items-center mt-[100px]">
    ...
    <form method="POST" action="{{ route('register') }}" class="flex flex-col items-center gap-5 w-full" enctype="multipart/form-data">
        @csrf
        <div class="ava flex flex-col items-center">
            <div class="flex items-center">
                <div class="relative w-20 h-20 rounded-full overflow-hidden">
                    ...
                    <input name="ava" id="avatar" type="file" accept="image/*" class="absolute inset-0 cursor-pointer opacity-0" onchange="previewAvatar(event)">
                </div>
            </div>
        ...
        <input name="email" class="w-1/3 border-black border-solid border-[1px] py-[13px] pl-[15px] rounded-lg" type="email" placeholder="Введите почту">
        ...
        <input name="password_confirmation" class="w-1/3 border-black border-solid border-[1px] py-[13px] pl-[15px] rounded-lg" type="password" placeholder="Повторите пароль">
